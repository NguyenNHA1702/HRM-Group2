    ...
    <nav class="sidebar-nav">
        <ul>
            ...
            <c:if test="${sessionScope.roleGroup eq 'EMPLOYEE'}">
                <c:if test="${sessionScope.roleGroup eq 'ADMIN' || (not empty sessionScope.userPermissions['ATTENDANCE'] && sessionScope.userPermissions['ATTENDANCE'].view)}">
                ...
                <c:if test="${sessionScope.roleGroup eq 'ADMIN' || (not empty sessionScope.userPermissions['LEAVE_MGMT'] && sessionScope.userPermissions['LEAVE_MGMT'].view)}">
                ...
                <c:if test="${sessionScope.roleGroup eq 'ADMIN' || (not empty sessionScope.userPermissions['PAYROLL'] && sessionScope.userPermissions['PAYROLL'].view)}">
                ...
                <c:if test="${sessionScope.roleGroup eq 'ADMIN' || (not empty sessionScope.userPermissions['SALARY_CONFIG'] && sessionScope.userPermissions['SALARY_CONFIG'].view)}">
            ...
            <c:if test="${sessionScope.roleGroup eq 'MANAGER'}">
                <c:if test="${sessionScope.roleGroup eq 'ADMIN' || (not empty sessionScope.userPermissions['EMPLOYEE_MGMT'] && sessionScope.userPermissions['EMPLOYEE_MGMT'].view)}">
            ...
            <c:if test="${sessionScope.roleGroup eq 'HR'}">
                ...
                <c:if test="${sessionScope.roleGroup eq 'ADMIN' || (not empty sessionScope.userPermissions['DEPT_MGMT'] && sessionScope.userPermissions['DEPT_MGMT'].view)}">
                ...
                <c:if test="${sessionScope.roleGroup eq 'ADMIN' || (not empty sessionScope.userPermissions['CONTRACT_MGMT'] && sessionScope.userPermissions['CONTRACT_MGMT'].view)}">
