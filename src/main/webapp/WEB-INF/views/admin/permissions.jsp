  ...
  <main class="flex-1 p-6 space-y-6">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
      <c:forEach var="role" items="${roles}">
        <div onclick="selectRole(${role.id}, '${role.name}', '${role.description}')"
    ...
    <div id="matrix-container" class="bg-white rounded-lg shadow hidden">
      ...
      <div class="overflow-x-auto">
        <table class="w-full">
          ...
          <tr>
            ...
            <th class="px-6 py-3 text-center text-xs font-medium text-gray-500 uppercase tracking-wider">Xem</th>
            <th class="px-6 py-3 text-center text-xs font-medium text-gray-500 uppercase tracking-wider">Tạo mới</th>
            <th class="px-6 py-3 text-center text-xs font-medium text-gray-500 uppercase tracking-wider">Chỉnh sửa</th>
            <th class="px-6 py-3 text-center text-xs font-medium text-gray-500 uppercase tracking-wider">Xóa</th>
          </tr>
          </thead>
      ...
      <div class="p-6 border-t border-gray-200 flex justify-end">
        <button id="btn-save-permissions" class="px-4 py-2 bg-indigo-600 text-white rounded-lg hover:bg-indigo-700 transition font-medium shadow-sm">
          Lưu thay đổi
        </button>
      </div>
    </div>
