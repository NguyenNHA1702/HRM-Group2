        ...
        <main class="content-area">
            ...
            <div class="page-header">
                <div class="page-title-group">
                    ...
                    <!-- Filter Bar -->
                    <form method="GET" action="${pageContext.request.contextPath}/hr/users" class="filter-bar">
                        ...
                        <select name="departmentId" class="filter-select">
                            ...
                            <c:forEach items="${departments}" var="dept">
                                <option value="${dept.id}" ${filterDepartmentId eq dept.id ? 'selected' : ''}>
                                    ${dept.name}
                                </option>
                            </c:forEach>
                        </select>
                        ...
                        <a href="${pageContext.request.contextPath}/hr/users" class="btn-reset">
                                    ...
                                    <c:otherwise>
                                        <c:forEach items="${employees}" var="emp" varStatus="loop">
                                            <tr>
                                                ...
                                                <td><c:out value="${not empty emp.departmentName ? emp.departmentName : 'Chưa phân bổ'}" /></td>
                        ...
                        <c:if test="${totalPages > 1}">
                            <div class="pagination">
                                ...
                                <div class="pagination-pages">
                                    <c:if test="${page > 1}">
                                        <a href="${pageContext.request.contextPath}/hr/users?page=${page - 1}&keyword=${filterKeyword}&departmentId=${filterDepartmentId}&positionId=${filterPositionId}&status=${filterStatus}" class="page-link">
                                            <i class="fa-solid fa-chevron-left"></i>
                                        </a>
                                    </c:if>

                                    <c:forEach begin="1" end="${totalPages}" var="p">
                                        <a href="${pageContext.request.contextPath}/hr/users?page=${p}&keyword=${filterKeyword}&departmentId=${filterDepartmentId}&positionId=${filterPositionId}&status=${filterStatus}" 
                ...
                <!-- Remove c:otherwise closing tag that was for noDepartment check -->
        </main>
    </div>
